...
# 一.安装
使用平板自带的浏览器, 输入 `http://54.149.244.137/apk/DCLMS_latest_release.apk`
下载完成以后点击安装
安装完成后点击梦想图书室   
输入被分配的图书室号  
点击确认 
...
- Tips: 有时导入失败的可能原因有两个， 一是因为豆瓣API的访问速度限制，请等待1小时再次尝试导入。第二个原因是输入的图书ISBN不正确，无法在豆瓣网上搜索到图书信息，这种情况请在豆瓣网上直接搜索图书名称，并更正导入文件中的ISBN为豆瓣网所显示的ISBN
...
|userId(读者号)|name(姓名)|gender(男生写1女生写2)|classInfo(对应班级管理中的班级名称)|borrowRestriction(对应身份管理中的身份名称)|
|---|---|---|---|---|
|900001|王小明|1|2年级1班|读者|
|900002|张小红|2|2年级3班|读者|
|...|...|...|...|...|
|900009|赵老师|2||管理员老师|
